...
Meteor.Collection = function (name, manager, driver, preventAutopublish, ctor) {
  var self = this;
...
Meteor.Collection.prototype._validatedUpdate = function(
  ...
  // if we are using models, pull out the raw data 
  // XXX: do we need a version of find[One] that is raw?
